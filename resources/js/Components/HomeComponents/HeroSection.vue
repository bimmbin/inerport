...
<template>
    ...
    >
        <div class="max-sm:text-center">
            <p
                class="w-[45rem] text-[2.7rem] font-bold leading-[3.5rem] max-xl:text-[1.9rem] max-xl:w-[30rem] max-xl:leading-[2.5rem] max-sm:w-screen max-sm:px-5 max-sm:text-2xl"
            >
            ...
            <h1
                class="text-xl opacity-50 font-light max-xl:text-lg max-sm:text-base max-sm:font-extralight"
            >
        ...
        <div
            class="w-[40rem] translate-y-[7rem] translate-x-[-3rem] max-sm:translate-y-0 max-sm:translate-x-0 max-sm:w-[22rem] max-sm:mt-10"
        >
            <LottieAnimation
