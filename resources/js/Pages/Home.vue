...
const record = ref("/img/record.svg");
const handshake = ref("/img/handshake.svg");
</script>
...
<template>
    ...
    >
        ...
        <div
            class="border-t-2 border-gray2 w-full flex justify-center items-center py-7 mt-9 max-xl:text-sm"
        >
